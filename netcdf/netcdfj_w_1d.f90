      SUBROUTINE NETCDFJ_W_1D(NWAV,WAV,TEMP,DUMMY,DLEN,FNAME,FLEN,UNITNAME,UNITLEN, &
			      LAT,LON,DATE,MON,YEAR,NSZA,SZA,NVZA,VZA,NPHI,PHI,WS)
...
!=============================================================================
      ...
      INTEGER :: NWAV, NSZA, NVZA, NPHI
      INTEGER :: ICNTN, NCID, RCODE, TIMESTEP
      INTEGER :: LATID, LONID, DATEID, MONID, YEARID, SZAID, VZAID, PHIID, WSID
      INTEGER :: WAVID, TEMPID
      INTEGER :: LATDIM, LONDIM, DATEDIM, MONDIM, YEARDIM, SZADIM, VZADIM, PHIDIM, WSDIM
      INTEGER :: WAVDIM
      INTEGER :: DLEN
      INTEGER :: FLEN
      INTEGER :: UNITLEN
...
! allocation.f
      ...
      DOUBLE PRECISION, DIMENSION(1), INTENT(IN)      :: WS
...
!=============================================================================
        ...
        WSID       = NCVID (NCID, 'WindSpeed',  RCODE)
...
! Create the dimensions of the dataset:
        ...
        WSDIM   = NCDDEF (NCID, 'WindSpeed', 1, RCODE)
...
!=============================================================================
        ...
        WSID  =  NCVDEF (NCID, 'WindSpeed', NCDOUBLE, 1, WSDIM, RCODE)
...
!=============================================================================
        ...
        CALL NCAPTC (NCID, PHIID, 'units', NCCHAR, 7, 'Degrees', &
                     RCODE)
        CALL NCAPTC (NCID, WSID, 'units', NCCHAR, 3, 'm/s', &
                     RCODE)
...
!=============================================================================
        ...
        CALL NCVPT (NCID, WSID, 1, 1, WS, RCODE)
