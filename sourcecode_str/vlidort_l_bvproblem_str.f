...
C  Return if Fourier component > 0 (Lambertian)
...
C  Lambertian condition
C  ====================

C  Skip if BRDF surface
...
C  Complete Lambertian case

      RETURN

C  BRDF surface condition
C  ======================
...
C     I         L_BVP_SURFACE_SETUP,   ! commented this line by xliu
     O         STATUS )
