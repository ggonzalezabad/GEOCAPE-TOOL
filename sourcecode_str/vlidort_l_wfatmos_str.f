...
C  Get the linearized TOA source terms
      ...
      IF ( DO_USER_STREAMS ) THEN
        CALL GET_L_TOA_SOURCE ( L_TOA_SOURCE, NV_PARAMETERS )
        DO UM = LOCAL_UM_START, N_USER_STREAMS
          DO O1 = 1, NSTOKES
            DO Q = 1, NV_PARAMETERS
...
C
      ...
      SUBROUTINE GET_L_TOA_SOURCE ( L_TOA_SOURCE, NV_PARAMETERS )
...
C    Only want the (1,1) component for Lambertian
...
C  Add Particular integral linearization
