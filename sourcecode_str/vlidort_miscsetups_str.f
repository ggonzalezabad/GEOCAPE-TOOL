...
C  Generalized to inlcude the BRDF case as well
C   RT Solutions Inc., 26 July 2010
...
C  Include file of BRDF variables (Input to the present module)
...
C  ---------------
      ...
      DOUBLE PRECISION X0_FLUX, X0_BOA, ATTN, REFLEC, SUM
...
C  Non-Lambertian case
C  -------------------

        IF ( .not. DO_LAMBERTIAN_SURFACE ) THEN

C  Solar beam reflected into quad directions
...
C  Solar beam reflected into User directions
