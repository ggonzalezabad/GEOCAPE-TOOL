...
C  Thermal transmittance only solution at BOA
...
C  Upwelling Jacobian output at Quadrature angles
     ...
     &          ( UTA, UT, N, N_SURFACE_WFS, FLUX_MULTIPLIER, 
     &            LS_BOA_THTONLY_SOURCE, QSURFACEWF_F )
            ELSE
              CALL QUADSURFACEWF_LEVEL_UP
     &          ( UTA, NLEVEL, N_SURFACE_WFS, FLUX_MULTIPLIER, 
     &            LS_BOA_THTONLY_SOURCE, QSURFACEWF_F )
            ENDIF
          ENDDO
        ENDIF
...
C
     ...
     &      ( UTA, NL, N_SURFACE_WFS, FLUX_MULTIPLIER,
     &        LS_BOA_THTONLY_SOURCE, QSURFACEWF_F )
...
C  end O1 and I loops, end Q loop
