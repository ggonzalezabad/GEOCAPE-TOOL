...
!        write(*,*)' ..calculating fourier component',FOURIER_COMPONENT
        ...
        CALL VLIDORT_FOURIER ( FOURIER_COMPONENT, DO_OBSERVATION_GEOMETRY, &
          ...
          NSTOKES, NSTREAMS, NLAYERS, NGREEK_MOMENTS_INPUT, NBEAMS, N_USER_VZANGLES, N_USER_RELAZMS, N_USER_LEVELS,      & !Input
          N_THERMAL_COEFFS, NFINELAYERS, NMOMENTS, NSTREAMS_2, NTOTAL, N_GEOMETRIES, N_SUBDIAG, N_SUPDIAG, NSTKS_NSTRMS, & !Input
          NSTKS_NSTRMS_2, N_PARTLAYERS, N_DIRECTIONS, NLAYERS_CUTOFF, N_ALLLAYERS_UP, N_ALLLAYERS_DN,                    & !Input
          ...
          LAMBERTIAN_ALBEDO, EXACTDB_BRDFUNC, BRDF_F, BRDF_F_0, USER_BRDF_F, USER_BRDF_F_0, EMISSIVITY, USER_EMISSIVITY, & !Input
          ...
          MS_CONTRIBS_F, STOKES_F, STATUS_SUB )                                                                            !Output
...
!
      ...
      SUBROUTINE VLIDORT_FOURIER ( FOURIER_COMPONENT, DO_OBSERVATION_GEOMETRY, &
        DO_SSCORR_NADIR, DO_SSCORR_OUTGOING, DO_SSCORR_TRUNCATION, DO_SSFULL, DO_SOLAR_SOURCES, DO_PLANE_PARALLEL,     & !Input
        DO_REFRACTIVE_GEOMETRY, DO_DELTAM_SCALING, DO_SOLUTION_SAVING, DO_BVP_TELESCOPING, DO_UPWELLING, DO_DNWELLING, & !Input
        DO_QUAD_OUTPUT, DO_ADDITIONAL_MVOUT, DO_MVOUT_ONLY, DO_TOA_CONTRIBS, DO_DIRECT_BEAM, DO_CLASSICAL_SOLUTION,    & !Input
        ...
        DO_MSMODE_THERMAL, DO_LAMBERTIAN_SURFACE, DO_THERMAL_EMISSION,DO_SURFACE_EMISSION, DO_REAL_EIGENSOLVER,        & !Input
        DO_LAYER_SCATTERING, DO_SPECIALIST_OPTION_2, DO_SPECIALIST_OPTION_3, DO_DEBUG_WRITE, DO_FDTEST,                & !Input
        NSTOKES, NSTREAMS, NLAYERS, NGREEK_MOMENTS_INPUT, NBEAMS, N_USER_STREAMS, N_USER_RELAZMS, N_USER_LEVELS,       & !Input
        N_THERMAL_COEFFS, NFINELAYERS, NMOMENTS, NSTREAMS_2, NTOTAL, N_GEOMETRIES, N_SUBDIAG, N_SUPDIAG, NSTKS_NSTRMS, & !Input
        NSTKS_NSTRMS_2, N_PARTLAYERS, N_DIRECTIONS, NLAYERS_CUTOFF, N_ALLLAYERS_UP, N_ALLLAYERS_DN,                    & !Input
        FLUX_FACTOR, FLUXVEC, SS_FLUX_MULTIPLIER, SZA_LOCAL_INPUT, USER_RELAZMS,                                       & !Input
        COS_SZANGLES, SIN_SZANGLES, SUN_SZA_COSINES, QUAD_STREAMS, QUAD_WEIGHTS, QUAD_STRMWTS, QUAD_HALFWTS,           & !Input
        ...
        MESSAGE, TRACE_1, TRACE_2,                                                                                     & !InOut
        DO_INCLUDE_THERMEMISS, DO_INCLUDE_SURFACE, DO_INCLUDE_SURFEMISS,                                               & !Output
        MS_CONTRIBS_F, STOKES_F, STATUS )                                                                                !Output
...
!    Should not be intent(inout) - Why (Note 17 December 2012)
...
!          (MAXSTREAMS_2,MAXLAYERS,MAX_USER_STREAMS)
      ...
      DOUBLE PRECISION :: PMULT_UD &
          (MAXSTREAMS_2,MAXLAYERS,MAX_USER_STREAMS)
      DOUBLE PRECISION :: PMULT_UU &
          (MAXSTREAMS_2,MAXLAYERS,MAX_USER_STREAMS)
...
!  Local Greens
              ...
              DO_LOCAL_GREENSFUNC(LAYER,IBEAM) = (NSTOKES.LE.3.and.&
                LAYER_MAXMOMENTS(LAYER).eq.3.and.FOURIER_COMPONENT.eq.0)
